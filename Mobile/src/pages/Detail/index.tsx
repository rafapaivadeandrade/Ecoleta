...
const Detail = () =>{
    ...
    function handleWhatsapp(){
        Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=I am interested about the waste collect`)
    }
    ...
    function handleMailComposer(){
      MailComposer.composeAsync({
        subject: 'Interest on waste collect',
    ...
    <View   style={styles.container}>
        ...
        <Text   style={styles.addressContent}>{data.point.province}</Text>
        </View>
    </View>
